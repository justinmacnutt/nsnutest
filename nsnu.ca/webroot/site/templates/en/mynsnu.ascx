...
<article id="content" role="main">
  <div class="inner clearfix">
    ...
    <div class="col2 ">
      <div class="inner">
        <OW:ContentBlock Position="content1" Display="Block" CssClass="ow_block" runat="server" />
            <OW:ContentBlock Position="announcement" Display="Block" CssClass="ow_block" runat="server" />
    ...
    <aside class="col1">
      <div class="inner">
        <div class="nav_sub">
          <OWSite:Menu runat="server" TransformSource="~/site/templates/SecondaryMenu.xslt" />
        </div>
        <OW:DependentBlock runat="server" DependsOnPosition="feature1">
        <div class="feature">
        </OW:DependentBlock>
          <OW:ContentBlock Position="feature1" Display="Block" CssClass="ow_block" runat="server" />
        <OW:DependentBlock runat="server" DependsOnPosition="feature1">
        </div>
        </OW:DependentBlock>
        <OW:DependentBlock runat="server" DependsOnPosition="feature2">
        <div class="feature">
        </OW:DependentBlock>
          <OW:ContentBlock Position="feature2" Display="Block" CssClass="ow_block" runat="server" />
        <OW:DependentBlock runat="server" DependsOnPosition="feature2">
        </div>
        </OW:DependentBlock>
      </div>
