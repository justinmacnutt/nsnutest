...
<script runat="server" language="vb">
    ...
    Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) handles MyBase.PreRender
        ...
        lnkMonth.Text = lnkMonth.Text.replace(",","")
...
<div id="ec_calendar">
	...
	<div class="ec_calendar_nav clearfix">
	    <div class="ec_calendarprev"><asp:LinkButton CausesValidation="false" id="lnkPrevious" runat="server">&laquo; Previous</asp:LinkButton></div>
	    <div class="ec_calendarnext"><asp:LinkButton CausesValidation="false" id="lnkNext" runat="server">Next &raquo;</asp:LinkButton></div>
	</div>

    </asp:PlaceHolder>
</div>
</ContentTemplate>
</asp:UpdatePanel><%-- Calendar.ascx - 7.0.4752 --%> 
