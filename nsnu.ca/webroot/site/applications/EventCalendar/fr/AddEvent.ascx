...
<div class="ec_requiredfield">
	...
	<asp:ValidationSummary Runat="server" DisplayMode="BulletList" ForeColor="" ID="vldSummary" EnableViewState="false" ValidationGroup="AddEvent"
...
<div class="ec_addeventfields">    
        ...
        <div class="ec_sf_group4 clearfix">
	        <div class="formlabel">
                <OWWeb:FieldLabel Runat="server" For="ec_lstCategory" ToolTip="Select the catgeory of the event.">
        ...
        <div class="ec_sf_group5 clearfix">
	        ...
	        <div class="forminput">
                ...
                <asp:CompareValidator ClientId="ec_DateCompare" runat="server" ControlToValidate="ec_dtEndDate"
                    ControlToCompare="ec_dtStartDate" Operator="GreaterThan" Type="Date" Text="The end date must be later than the start date." 
        ...
        <div class="ec_sf_group6 clearfix" style="margin-left:30px;">
 	        <%-- Start Time --%>                    
			<div class="formlabel">
				<OWWeb:FieldLabel Runat="server" for="ec_tmStartTime" Text="Start time" ToolTip="Select the time that the event begins." />
			</div>
	        <div class="forminput">
				<telerik:RadTimePicker ID="ec_tmStartTime" runat="server" ShowPopupOnFocus="true"
					DateInput-DateFormat="t" TimeView-ShowHeader="false" TimeView-TimeFormat="t" TimeView-HeaderText="Select start time"/>
			...
			<div class="formlabel">
				<OWWeb:FieldLabel Runat="server" for="ec_tmEndTime" Text="End time" ToolTip="Select the time that the event ends."/>
			</div>
	        <div class="forminput">
				<telerik:RadTimePicker ID="ec_tmEndTime" runat="server" ShowPopupOnFocus="true" 
					...
					TimeView-Interval="00:15:00" TimeView-TimeFormat="t" TimeView-HeaderText="Select end time" />
                <asp:CompareValidator ClientId="ec_cvTimeCompare" runat="server" ControlToValidate="ec_tmEndTime"
                    ControlToCompare="ec_tmStartTime" Operator="GreaterThanEqual" Type="String" Text="The end time must be later than the start time." 
                    Display="Dynamic" EnableClientScript="False" CssClass="invalid" ValidationGroup="AddEvent"/>
			</div>   
        </div>      
        ...
        <div class="ec_sf_group9 clearfix">
	        ...
	        <div class="forminput">
	            ...
	            <asp:RegularExpressionValidator ClientID="ec_cvSummaryLength" Runat="server" ControlToValidate="ec_txtSummary" ValidationExpression="^[\s\S]{0,255}$"
			            Text="Summary cannot exceed 255 characters." EnableClientScript="False" Display="Dynamic" CssClass="invalid" ValidationGroup="AddEvent"/>
              </div>   		
        </div>
        ...
        <div class="ec_sf_group10 clearfix">
	        ...
	        <div class="forminput">
			    ...
			    <asp:RegularExpressionValidator ClientId="ec_cvDescriptionLength" ControlToValidate="ec_txtDescription" runat="server" ValidationExpression="^[\s\S]{0,1024}$"
				    Text="Full description cannot exceed 1024 characters." Display="Dynamic" CssClass="invalid" EnableClientScript="False" ValidationGroup="AddEvent" />
            </div> 		        
        </div>
        ...
        <div class="ec_sf_group14 clearfix">
	        <div class="formlabel">
                <OWWeb:FieldLabel Runat="server" For="ec_txtWebsite" ToolTip="Provide the URL of the website where more details about this event exist.">
                    Event website
		        </OWWeb:FieldLabel>
	        </div>
	        <div class="forminput">
