...
<div id="ec_eventCalendar">
    ...
    <div class="ec_List clearfix" id="ec_List">
	    ...
	    <div class="ow_pagerListWrapper">
		    <ul id="ow_pagerList">
			    ...
			    <li class="ow_pagerLinks"><a id="emop_lnkPage2" href="javascript:void(2);" title="Page 2 of results">2</a></li>
			    <li class="ow_pagerLinks"><a id="emop_lnkPage3" href="javascript:void(3);" title="Page 3 of results">3</a></li>
			    <li class="ow_pagerLinks"><a id="emop_lnkPage4" href="javascript:void(4);" title="Page 4 of results">4</a></li>
			    <li class="ow_pagerLinks"><a id="emop_lnkPage5" href="javascript:void(5);" title="Page 5 of results">5</a></li>
				<li class="ow_pagerNext">
					<a id="ow_lnkNextGrp" href="javascript:void('grp');">...</a>
					<a id="ow_lnkNext" href="javascript:void('next');">Next &gt</a>
				</li>
		    </ul>
	    </div>
	</div>
    ...
    <div class="ec_Details clearfix" id="ec_Details">
			<div class="ec_detailsPager"><table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td style="text-align:left;"><a href="javascript:void('prev');" title="Previous event" id="lnkPrev1">&laquo; Previous</a></td>
					<td style="text-align:right;"><a href="javascript:void('next');" title="Next event" id="lnkNext1">Next &raquo;</a></td>
				</tr>
			</table></div>
			...
			<div class="ec_detailsInfo">
				<div class="ec_headers clearfix">
					...
					<div class="ec_details_info">
						...
						<div class="ec_details_website"><a id="lnkWebsite" href="javascript:void('web');">View event website</a></div>
						<div class="ec_details_contactName">Contact: Bob Jones</div>
						<div class="ec_details_contactPhone">Phone: 904 405-3104</div>
						<div class="ec_details_contactEmail">Email: <a href="mailto:theevent.com">bjones@theevent.com</a></div>
					</div>
			...
			<div class="ec_detailsPager"><table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td style="text-align:left;"><a href="javascript:void('prev');" title="Previous event" id="lnkPrev2">&laquo; Previous</a></td>
					<td style="text-align:right;"><a href="javascript:void('next');" title="Next event" id="lnkNext2">Next &raquo;</a></td>
				</tr>
			</table></div>
    </div>
    ...
    <div class="ec_Calendar clearfix" id="ec_Calendar">
		...
		<div class="ec_calendartable"><table style="border-width: 1px; border-collapse: collapse;" id="ecCalendar_calEvents"
				title="Calendar" cellspacing="0" cellpadding="0"><tbody>
					<tr>
						<th class="ec_calendar_dayheader" abbr="Sunday" scope="col" align="center">S</th>
						<th class="ec_calendar_dayheader" abbr="Monday" scope="col" align="center">M</th>
						<th class="ec_calendar_dayheader" abbr="Tuesday" scope="col" align="center">T</th>
						<th class="ec_calendar_dayheader" abbr="Wednesday" scope="col" align="center">W</th>
						<th class="ec_calendar_dayheader" abbr="Thursday" scope="col" align="center">T</th>
						<th class="ec_calendar_dayheader" abbr="Friday" scope="col" align="center">F</th>
						<th class="ec_calendar_dayheader" abbr="Saturday" scope="col" align="center">S</th>
					</tr>
		...
		<div class="ec_calendar_nav clearfix">
			<div class="ec_calendarprev"><a id="ecCalendar_lnkPrevious" href="javascript:void('prev')">« Previous</a></div>&nbsp;
			<div class="ec_calendarnext"><a id="ecCalendar_lnkNext" href="javascript:void('next')">Next »</a></div>
		</div>
    </div>
