    ...
    <div class="clearfix">
        ...
        <aside class="col1">
          <div class="inner">
            ...
            <div class="events">
              <OW:ContentBlock Position="feature_left1" Display="Block" CssClass="ow_block" runat="server" />
              <OW:ContentBlock Position="feature_left2" Display="Block" CssClass="ow_block" runat="server" />
              <OW:ContentBlock Position="feature_left3" Display="Block" CssClass="ow_block" runat="server" />
            </div>
          </div>
        </aside>
    </div>
